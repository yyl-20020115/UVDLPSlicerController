...
public partial class MainForm : Form
{
    ...
    DLPForm m_frmdlp = new DLPForm();
    SliceOptionsForm m_frmsliceopt = new SliceOptionsForm();
    ControlForm m_frmcontrol = new ControlForm();
    SliceForm m_frmSlice = new SliceForm();
    GCodeRawForm m_sendgcode = new GCodeRawForm();
...
//glEnable(GL_LINE_SMOOTH);
    ...
    */
    ...
    {
        MachineConfigForm mf = new MachineConfigForm();
        mf.ShowDialog();
    }
